...
files=[
  ('text_files',('pepg-S-1-1835597-000119312522106884.xbrl',open('test_{{ cookiecutter.pipeline_package }}/test_docs/pepg-S-1-1835597-000119312522106884.xbrl','rb'),'application/octet-stream')),
  ('text_files',('rgld-10-K-85535-000155837021011343.xbrl',open('test_{{ cookiecutter.pipeline_package }}/test_docs/rgld-10-K-85535-000155837021011343.xbrl','rb'),'application/octet-stream'))
]
...
def test_pipeline_1(test_client, files, output_format, output_schema, status_code, headers):
    ...
    response = test_client.post(
        "/{{ cookiecutter.pipeline_package }}/v0.0.1/text-input",
        files=files,
