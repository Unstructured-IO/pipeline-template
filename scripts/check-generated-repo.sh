...
# Creates a pipeline-testproject (by default) in the current directory with
# "make generate-repo." Then, runs the usual make commands within
# pipeline-testproject/, and ultimately validates the autogenerated FastAPIs.
